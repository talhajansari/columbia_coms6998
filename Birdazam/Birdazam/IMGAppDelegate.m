...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Paintbrush (ViewController)
    // Old: UIViewController *colorTouchVC = [[UIViewController alloc] init];
    self.viewController = [[IMGViewController alloc] init];
    
    // Paint (View)
    // Code in IMGViewController
